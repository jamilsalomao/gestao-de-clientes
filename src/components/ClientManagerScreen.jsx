    ...
    return (
      <SafeAreaView style={styles.container}>
        ...
        <View style={styles.card}>
          <MaterialCommunityIcons name="format-list-checks" size={50} color="#6366F1" />
          ...
          <TouchableOpacity style={styles.primaryButton}>
            <MaterialCommunityIcons name="plus-circle" size={22} color="#FFFFFF" style={styles.buttonIcon} />
            <Text style={styles.primaryButtonText}>Novo Cliente/Serviço</Text>
          </TouchableOpacity>
          </Link>
  
          <TouchableOpacity style={styles.secondaryButton}>
            <MaterialCommunityIcons name="account-group" size={22} color="#FFFFFF" style={styles.buttonIcon} />
