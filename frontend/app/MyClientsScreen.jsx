...
const MyClientsScreen = () => {
  ...
  const filteredClients = useMemo(() => {
    const parseDate = (dateString) => {
      if (!dateString) return new Date(0); // Data muito antiga se a data for inválida
        ...
        <View style={styles.card}>
          ...
          <View style={styles.cardContent}>
            ...
            <View style={styles.statusContainer}>
              <MaterialCommunityIcons name={statusIcon} size={16} color={color} />
              <Text style={styles.statusText} numberOfLines={1}>{item.timeline[0]?.description}</Text>
            </View>
          </View>
        </View>
      </TouchableOpacity>
  ...
  return (
    <SafeAreaView style={styles.container}>
      <Stack.Screen options={{ title: "Meus Clientes", headerTitleAlign: "center", headerShadowVisible: false }} />
      <StatusBar barStyle="dark-content" />
      <ClientDetailModal visible={isModalVisible} onClose={handleCloseModal} clientId={selectedClientId} />
      <FlatList
        ...
        ListHeaderComponent={
          <>
            <View style={styles.tabsContainer}>
              ...
              >
                <Text style={[styles.tabText, activeTab === "ativos" && styles.activeTabText]}>
                  Ativos
                </Text>
              </TouchableOpacity>
              <TouchableOpacity
              ...
              >
                <Text style={[styles.tabText, activeTab === "concluidos" && styles.activeTabText]}>
                  Concluídos
                </Text>
              </TouchableOpacity>
            </View>
            ...
            <View style={styles.dashboardContainer}>
              ...
              <View style={styles.legendContainer}>
                <View style={styles.legendItem}>
                  <View style={[styles.legendColor, { backgroundColor: "#DB7105" }]}/>
                  <Text style={styles.legendText}>Ativos</Text>
                </View>
                <View style={styles.legendItem}>
                  <View style={[styles.legendColor, { backgroundColor: "#0E2C40" }]}/>
